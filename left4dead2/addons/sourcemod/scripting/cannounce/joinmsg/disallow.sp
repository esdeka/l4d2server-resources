...
Action Command_DisAllowJoinMsg(int client, int args)
{
	char target[65];
...
Action Command_DisAllowJoinMsgID(int client, int args)
{
	char steamId[24];
	//not enough arguments, display usage
	if (args < 1)
...
bool DisAllowJoinMsg(char[] steamId)
{
	...
	{	
		hKVCustomJoinMessages.DeleteThis();
...
int MenuHandler_DisAllowJoinMsg(Menu menu, MenuAction action, int param1, int param2)
{
