...
public void AdminMenu_AllowJoinMsg(Handle topmenu, TopMenuAction action, TopMenuObject object_id, int param, char[] buffer, int maxlength)
{
...
{
	Handle menu = CreateMenu(MenuHandler_AllowJoinMsg);
...
public int MenuHandler_AllowJoinMsg(Handle menu, MenuAction action, int param1, int param2)
{
