...
Action Command_AllowJoinMsg(int client, int args)
{
	char target[65];
...
Action Command_AllowJoinMsgID(int client, int args)
{
...
bool AllowJoinMsg(char[] steamId, char[] player_name)
{
	...
	{
		hKVCustomJoinMessages.JumpToKey(steamId, true);
		hKVCustomJoinMessages.SetString("playerwasnamed", player_name);
...
int MenuHandler_AllowJoinMsg(Menu menu, MenuAction action, int param1, int param2)
{
