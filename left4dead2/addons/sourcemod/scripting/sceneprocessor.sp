...
public OnPluginStart()
{
	...
	if (!g_IsL4D1)
	{
		new Handle:convar = CreateConVar(CONVAR_JAILBREAK_VOCALIZE_COMMAND_NAME, CONVAR_JAILBREAK_VOCALIZE_COMMAND_VALUE, CONVAR_JAILBREAK_VOCALIZE_COMMAND_DESC, FCVAR_PLUGIN)
